...
<section id="list-ventas">
	...
	<div class="row">
      ...
      <div class=" container card arriendo-card text-left">
          <div class="card-img-block mt-4 mb-2">
              ...
              <hr>
                <p class="venta-card-text">
                  <small class="text-muted">
                    <i class="fa fa-bath"></i>2
                    <i class="fa fa-bed"></i>2
                    <i class="fa fa-car"></i>1
                    <i class="fa fa-object-group"></i>800 m<sup>2</sup></small>
                  </p>
            </div>
          </div>
      </div>   
